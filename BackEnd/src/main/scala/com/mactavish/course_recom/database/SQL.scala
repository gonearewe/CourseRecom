...
object SQL {
  ...
  private def runGenericFileSourceOptionsExample(spark: SparkSession): Unit = {
    ...
    val beforeFilterDF = spark.read.format("parquet")
      ...
      .option("modifiedBefore", "2020-12-23T05:30:00")
      .load("../resources/dir1");
    beforeFilterDF.show();
    // +-------------+
    // |         file|
    ...
    val afterFilterDF = spark.read.format("parquet")
      ...
      .option("modifiedAfter", "2020-12-25T05:30:00")
      .load("../resources/dir1");
    afterFilterDF.show();
    // +-------------+
    // |         file|
  ...
  private def runBasicDataSourceExample(spark: SparkSession): Unit = {
    ...
    usersDF.select("name", "count").write.save("namesAndFavColors.parquet")
    ...
    usersDF.write.format("orc")
      .option("orc.bloom.filter.columns", "count")
    ...
    usersDF.write.partitionBy("count").format("parquet").save("namesPartByColor.parquet")
